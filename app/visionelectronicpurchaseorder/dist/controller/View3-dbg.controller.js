    ...
    return Controller.extend("visionelectronicpurchaseorder.controller.View3", {
        ...
        onPrintPO() {
            ...
            aContexts.forEach((oCtx) => {
                ...
                const fTaxPct     = parseFloat(oItem.TaxPercent      || 0);
                // IGST / CGST / SGST are percentage fields from the backend
            ...
            const printContent = `
                ...
                <body>
                    ...
                    <div class="page">
                        ...
                        <p class="tc-text">The Buyer may cancel or modify any Purchase Order at any time before shipment without any charges or penalties. Any changes will be communicated in writing. The Supplier shall accept equitable adjustments to price or delivery schedule where appropriate.</p>
                        ...
                        <p class="tc-text">Supplier shall comply with all applicable laws, safety norms, environmental regulations, and ethical standards. Goods and/or services must be genuine and free from third-party claims.</p>
